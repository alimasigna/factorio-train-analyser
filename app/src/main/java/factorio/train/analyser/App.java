...
import factorio.train.analyser.UI.MainUI;
...
public class App {
    ...
    public static void main(String[] args) {
        ...
        if (args.length > 0) {
            String blueprint = args[0];
            boolean result = trainAnalyser(blueprint);
            System.out.println("\n \n ------------------------------------------------------------------------------\n \n");
